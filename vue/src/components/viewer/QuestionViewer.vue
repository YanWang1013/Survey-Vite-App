        ...
        <div class="mt-3">
            ...
            <div v-else-if="question.type === 'radio'">
                <div
                    ...
                    :key="option.uuid"
                    class="form-check form-check-inline ml-10"
                >
                    <input
                        :id="option.uuid"
                        ...
                        @change="emits('update:modelValue', $event.target.value)"
                        type="radio"
                        class="focus:ring-indigo-500 h-4 w-4 text-sky-600 border-gray-300 form-check-input"
                        :checked="question.currentAnswer === option.text"
                    />
                    <label
                        :for="option.uuid"
                        class="ml-3 block text-sm font-medium text-gray-700 form-check-label"
                    >
                        {{ option.text }}
                    </label>
                </div>
            ...
            <div v-else-if="question.type === 'checkbox'">
                ...
                >
                    <input
                        ...
                        type="checkbox"
                        class="focus:ring-indigo-500 h-4 w-4 text-sky-600 border-gray-300 rounded"
                    />
                    <label
                        :for="option.uuid"
