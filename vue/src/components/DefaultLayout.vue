...
export default {
    ...
    setup() {
        ...
        if (current_user_role === Constants.ADMIN_ROLE) {
            navigation.push({ name: "Administrators", to: { name: "Administrators" } });
        }
        if (current_user_role >= Constants.MANAGER_ROLE) {
            navigation.push({ name: "Users", to: { name: "Guests" } });
        }
