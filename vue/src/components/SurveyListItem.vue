<template>
    ...
    >
        ...
        <div class="flex justify-between items-center mt-3">
            <TButton v-if="current_user_role > Constants.GUEST_ROLE" :to="{ name: 'SurveyView', params: { id: survey.id } }">
            ...
            <div class="flex items-center">
                ...
                <TButton v-if="survey.id && current_user_role > Constants.GUEST_ROLE" @click="emit('delete', survey)" circle link color="red">
